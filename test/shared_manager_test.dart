import 'package:calacirya/src/core/manager/cache/shared_manager.dart';
...
void main() {
  ...
  group('SharedManager Tests', () {
    ...
    setUp(() async {
      ...
      sharedManager = SharedManager.withSharedPreferences(sharedPreferences);
    });
